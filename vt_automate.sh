...
#cleanup from an previous scans
...
#Move extracted files to folder and remove duplicates based on md5
...
sed -i 's/Emsisoft,\|GData,\|Ad-Aware,\|AVware,\|AegisLab,\|AhnLab-V3,\|Antiy-AVL,\|International,\|CAT-QuickHeal,\|CMC,\|ClamAV,\|Commtouch,\|DrWeb,\|ESET-NOD32,\|F-Secure,\|Jiangmin,\|K7GW,\|Unwanted-File\|Kaspersky,\|McAfee,\|MicroWorld-eScan,\|NANO,\|Norman,\|Rising,\|SUPERAntiSpyware,\|Symantec,\|TotalDefense,\|Comodo,\|TrendMicro-HouseCall,\|Sophos,\|VBA32,\|Qihoo-360,\|VIPRE,\|K7AntiVirus,\|Fortinet,\|Ikarus,\|TheHacker,\|AVG,\|Agnitum,\|V3,\|Zillya,\|AntiVir,\|ViRobot,\|Avast,\|Baidu-International,\|( 6b49d2001 ),\|BitDefender,\|Bkav,\|ByteHero,\|F-Prot,\|Kingsoft,\|Malwarebytes,\|McAfee-GW-Edition,\|Microsoft,\|NANO-Antivirus,\|Panda,\|Tencent,\|WS.Reputation.1\|TrendMicro,\|Zoner,\|nProtect\|,,//g' /nsm/bro/vt_scan/archive/logs/raw.csv && sed -i 's/-,/ /g' /nsm/bro/vt_scan/archive/logs/raw.csv && sed -i '/Error!\|Failed!/d' /nsm/bro/vt_scan/archive/logs/raw.csv && sed -i -r 's/(, *)+/, /g' /nsm/bro/vt_scan/archive/logs/raw.csv 
...
sed '/md5sum/d' /nsm/bro/vt_scan/archive/logs/raw.csv 
