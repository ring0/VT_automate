...
try:
   ...
   fout.write("md5sum" + separator + "timeStamp" + separator + "filename" + separator + "NumberOfAVs" + separator + "NumberOfDetects" + separator + ("<av>" + separator + "<result>" + separator)* 51 + "permalink\n")
